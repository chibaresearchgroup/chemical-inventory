 ...
 *
 * This isn't a cosmetic default — per LICENSE, keeping this credit visible
 * and unmodified on every page is a condition of the permission to use this
 * software. Do not remove, hide, or reword it.
 */
