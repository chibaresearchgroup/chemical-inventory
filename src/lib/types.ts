...
export interface Chemical {
  id: string
  /** Short human-readable label, also encoded in the QR sticker. e.g. ChibaLab-0042 */
  code: string
  name: string
  cas: string | null
  system: string | null
   ...
   *  PubChem's own substructure index for rows that were bulk-imported and
   *  never got a hand-drawn structure_molfile. Null until enrichment runs. */
