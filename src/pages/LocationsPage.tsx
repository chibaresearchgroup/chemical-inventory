        ...
        <div className="flex flex-col gap-3 lg:flex-row lg:items-end">
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-1 text-xs text-ink-500 dark:text-ink-400">
              ChibaLab includes the lab map by default. Add extra temporary shelves, boxes, benches, or new cabinets here.
            </p>
          </div>
          <div className="grid gap-2 sm:grid-cols-[150px_minmax(220px,1fr)_100px_auto] lg:min-w-[680px]">
            ...
            <button
              ...
              title={isAdmin ? 'Add to ChibaLab location dropdowns' : 'Only admins can edit the shared location dropdowns.'}
            >
