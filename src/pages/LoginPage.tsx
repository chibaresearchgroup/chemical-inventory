    ...
    <div className="grid min-h-full lg:grid-cols-2">
      ...
      <div className="relative hidden overflow-hidden bg-[#0b1830] lg:flex lg:flex-col lg:p-12">
        ...
        <div className="relative flex items-center gap-3">
          ...
          <div>
            <div className="text-lg font-extrabold tracking-tight text-white">ChibaLab</div>
      ...
      <div className="flex items-center justify-center px-5 py-10 sm:px-10">
        <div className="w-full max-w-sm">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-base font-extrabold tracking-tight text-ink-900 dark:text-ink-50">
                  ChibaLab <span className="font-medium text-pearl-600 dark:text-pearl-400">Inventory</span>
                </div>
                <div className="text-[10px] font-medium text-ink-400">{LAB_SUBTITLE}</div>
              </div>
            </div>
            <NtuBadge />
          </div>
          ...
          <p className="mt-8 text-center text-xs leading-relaxed text-ink-400">{LAB_SUBTITLE}</p>
        </div>
      </div>
    </div>
  )
