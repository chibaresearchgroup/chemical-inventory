-- ===========================================================================
--  ChibaLab Inventory — database schema
--  ChibaLab Group · Prof. Xiaogang Liu Lab · NTU Singapore
--
--  HOW TO USE
...
-- Allocate the next ChibaLab-#### code. Used when the client doesn't supply one.
